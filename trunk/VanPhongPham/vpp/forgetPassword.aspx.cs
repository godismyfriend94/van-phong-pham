...
public partial class vpp_forgetPassword : System.Web.UI.Page
{
    ...
    protected void btnGetPassword_Click(object sender, EventArgs e)
    {
        ...
        if (tblUser != null)
        {
            ...
            try
            {
                password = RandomPassword.Generate(6, 6);
            }
            catch(Exception ex)
            {
                password = "123456";
            ...
            tblUser.Password = md5Password;

            if (tblUserLogic.ChangePassword(tblUser))
            {
                ...
                <html>
                    ...
                    <body>
                        <Table>
                            ...
                            <tr>
                                <td>
                                    Lưu ý: Thay đổi mật khẩu này sau khi đăng nhập. Đây là thư gửi tự động, làm ơn không trả lời! xin cảm ơn!
                                </td>
                            </tr>" +
                ...
                {
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "anz.vnn.vn", "<script>alert('Không thể gửi mật khẩu vào hòm thư của bạn')</script>", false);
                }
            }
            else
            {
                ScriptManager.RegisterStartupScript(this, typeof(Page), "anz.vnn.vn", "<script>alert('Lỗi hệ thống, vui lòng thử lại sau')</script>", false);
            }
